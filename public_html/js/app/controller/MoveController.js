...
app.controller.MoveController.prototype.update = function update(timeDelta) {
    ...
    for (elementIndex = 0; elementIndex < listLength; elementIndex++) {
        ...
        moveVector = new support.geom.SimpleVector2d(nextStepX - element.getTemporaryX(), nextStepY - element.getTemporaryY());
        ...
        element.setTemporaryX(element.getTemporaryX() + normalizedMoveVector.getX() * timeDelta / 1000 * element.getGroundSpeed());
        element.setTemporaryY(element.getTemporaryY() + normalizedMoveVector.getY() * timeDelta / 1000 * element.getGroundSpeed());
