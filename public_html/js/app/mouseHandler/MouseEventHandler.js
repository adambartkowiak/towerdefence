    ...
    if (this._hudModel.getTowerGuidForCurrentMenu() === -1) {
        if (mapField.getEmpty() === true) {
            if (this._hudModel.getCash() >= 200) {
                var bullet = new app.objects.Bullet(0, 0, null, 250000, 0.1, "assets/images/bullet0.png");
                towerList.addTower(new app.objects.Tower(towerX, towerY, 3000, 50, bullet, "assets/images/tower0.png"));
